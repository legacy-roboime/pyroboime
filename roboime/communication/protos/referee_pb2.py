...
_SSL_REFEREE_STAGE = descriptor.EnumDescriptor(
  name='Stage',
...
_SSL_REFEREE_COMMAND = descriptor.EnumDescriptor(
  name='Command',
...
_SSL_REFEREE_TEAMINFO = descriptor.Descriptor(
  name='TeamInfo',
...
_SSL_REFEREE = descriptor.Descriptor(
  name='SSL_Referee',
...
class SSL_Referee(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  
  class TeamInfo(message.Message):
    __metaclass__ = reflection.GeneratedProtocolMessageType
