...
class Intelligence(QtCore.QThread):
    ...
    def __init__(self, world):
        ...
        self.plays = {
            ...
            'indirect_b' : indirectkick.IndirectKick(world.blue_team, 0),
            #'indirect_y' : indirectkick.IndirectKick(world.yellow_team, 0),
        }
    ...
    def _loop(self):
        if 2 in self.world.blue_team:
            ...
            if self.skill is None:
                self.skill = sampledchipkick.SampledChipKick(r, lookpoint=self.world.blue_team[0], receiver=self.world.blue_team[0])
